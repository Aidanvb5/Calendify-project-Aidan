...
export default function Home() {
  return (
    <div className="container px-5 my-5">
      ...
      <h2>Adding new database migrations</h2>
      <p>
        Whenever you make a change to the <b>DatabaseContext</b>, you will need to add a new migration.
        All the database changes are managed from the <i>/Migrations/</i> folder; the content of this folder is automatically generated. Do not edit this file by hand.
      ...
      <p>
        ...
        After every migration, you will also need to run <i>dotnet ef database update</i>, which will apply the changes to the database.
      </p>
